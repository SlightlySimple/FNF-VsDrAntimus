...
class KadeEngineData
{
	public static function initSave()
	{
	    ...
	    if (FlxG.save.data.stepManiaColors == null)
			FlxG.save.data.stepManiaColors = [4,1,2,3,2,0];

	    if (FlxG.save.data.rotateNotes == null)
			FlxG.save.data.rotateNotes = true;
		...
		if (FlxG.save.data.editorZoom == null)
			FlxG.save.data.editorZoom = 0.4;

		if (FlxG.save.data.zoom == null)
			FlxG.save.data.zoom = 1;
		
		if (FlxG.save.data.colorIcons == null)
			FlxG.save.data.colorIcons = true;
		...
		if (FlxG.save.data.laneBorder == null)
			FlxG.save.data.laneBorder = 25;
		...
		if (FlxG.save.data.extraSongInfo == null)
			FlxG.save.data.extraSongInfo = true;
		
		if (FlxG.save.data.antimusProgress == null)
			FlxG.save.data.antimusProgress = [0,0,0,0,0];
