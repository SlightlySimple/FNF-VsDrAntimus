...
class Paths
{
	...
	// same shit as above, just returns an array instead
	static public function loadJSONArray(key:String, ?library:String):Array<Dynamic>
	{
		var rawJson = OpenFlAssets.getText(Paths.json(key, library)).trim();
	...
	// Insert Gordon Ramsay joke here
	static public function loadJSONRaw(key:String, ?library:String):String
	{
		var rawJson = OpenFlAssets.getText(Paths.json(key, library)).trim();
	...
	inline static public function hs(key:String, ?library:String)
	{
		return getPath('data/$key.hs', TEXT, library);
	}
	...
	inline static public function voices(song:String, ?diff:String = "Normal")
	{
		var songLowercase = StringTools.replace(song, " ", "-").toLowerCase();
		var result = 'songs:assets/songs/${songLowercase}/Voices.$SOUND_EXT';
		if (diff == "Solo")
			result = 'songs:assets/songs/${songLowercase}/VoicesSolo.$SOUND_EXT';
