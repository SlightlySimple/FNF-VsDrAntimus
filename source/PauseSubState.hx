...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['pauseResume', 'pauseRestart', 'pauseSkip', 'pauseOptions', 'pauseExit'];
	...
	public function new()
	{
		...
		menuItems = ['pauseResume', 'pauseRestart', 'pauseSkip', 'pauseOptions', 'pauseExit'];
		if (!PlayState.instance.canSkipSong())
			menuItems.remove('pauseSkip');
		...
		levelInfo.text += CoolUtil.translate(PlayState.SONG.songId);
		...
		levelDifficulty.text += CoolUtil.translate(PlayState.storyDifficulty).toUpperCase();
		...
		{
			var songText:Alphabet = new Alphabet(0, (70 * i) + 30, CoolUtil.translate(menuItems[i]), true, false);
