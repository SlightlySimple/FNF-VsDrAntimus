...
class DiffOverview extends FlxSubState
{
	...
	override function create()
	{
		...
		SONG = FreeplayState.songData.get(FreeplayState.songs[FreeplayState.curSelected].songName);
		SongNotes = FreeplayState.noteData.get(FreeplayState.songs[FreeplayState.curSelected].songName + FreeplayState.curDifficulty);
	...
	{
		var songData = FreeplayState.songData.get(FreeplayState.songs[FreeplayState.curSelected].songName);
		...
		var noteData:Array<SwagSection> = FreeplayState.noteData.get(FreeplayState.songs[FreeplayState.curSelected].songName + FreeplayState.curDifficulty);
		...
		Conductor.mapBPMChanges(SONG, SongNotes);
